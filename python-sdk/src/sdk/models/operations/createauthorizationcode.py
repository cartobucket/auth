...
from ..shared import passwordauthrequest as shared_passwordauthrequest
from enum import Enum
from typing import Optional

class CreateAuthorizationCodeResponseTypeEnum(str, Enum):
    CODE = 'code'
...
class CreateAuthorizationCodeRequest:
    ...
    password_auth_request: shared_passwordauthrequest.PasswordAuthRequest = dataclasses.field(metadata={'request': { 'media_type': 'multipart/form-data' }})
    response_type: CreateAuthorizationCodeResponseTypeEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'response_type', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class CreateAuthorizationCodeResponse:
