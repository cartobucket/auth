...
data class WellKnown(
    ...
    enum class ResponseTypesSupportedEnum(
        val value: String,
    ) {
        CODE("code"),
        TOKEN("token"),
    ...
    enum class SubjectTypesSupportedEnum(
        val value: String,
    ) {
        PUBLIC("public"),
        ;
    ...
    enum class IdTokenSigningAlgValuesSupportedEnum(
        val value: String,
    ) {
        RS256("RS256"),
        RS512("RS512"),
    ...
    enum class ScopesSupportedEnum(
        val value: String,
    ) {
        OPENID("openid"),
        EMAIL("email"),
    ...
    enum class TokenEndpointAuthMethodsSupportedEnum(
        val value: String,
    ) {
    ...
    enum class ClaimsSupportedEnum(
        val value: String,
    ) {
        AUD("aud"),
        EXP("exp"),
    ...
    enum class CodeChallengeMethodsSupportedEnum(
        val value: String,
    ) {
        S256("S256"),
        ;
