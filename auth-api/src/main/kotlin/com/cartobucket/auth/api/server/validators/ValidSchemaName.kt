...
@Constraint(validatedBy = [ValidSchemaName.Validator::class])
@Target(
...
@MustBeDocumented
annotation class ValidSchemaName(
    ...
    class Validator : ConstraintValidator<ValidSchemaName, String> {
        override fun initialize(constraintAnnotation: ValidSchemaName) {
