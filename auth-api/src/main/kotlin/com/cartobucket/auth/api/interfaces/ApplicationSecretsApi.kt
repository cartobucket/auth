...
interface ApplicationSecretsApi {
    ...
    fun createApplicationSecret(@Valid @NotNull applicationSecretRequest: ApplicationSecretRequest): Response
    ...
    @DELETE
    @Path("/{secretId}/")
    fun deleteApplicationSecret(@PathParam("secretId") secretId: UUID): Response
