...
public class ClientRequestFilter {
    ...
    public ClientRequestFilter() {}

    public ClientRequestFilter authorizationServerIds(List<UUID> authorizationServerIds) {
    ...
    public boolean equals(Object o) {
        ...
        ClientRequestFilter that = (ClientRequestFilter) o;
